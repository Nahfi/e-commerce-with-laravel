...
<body>
    ...
    <div class="small-container">
       ...
       @endif
            ...
            <div class="col-xs-8">
                      <div class="row">
                        ...
                        <div class="col-xs-4" style="padding: 10px">
                          <a href="{{ url("/products/".$fetch->id) }}"><img src="{{ asset(explode('|',$fetch->image )[0])}}"  alt="product_image" style="height:200px; width:180px ; margin-bottom:10px"></a>
                            <h4>{{ $fetch->name }}</h4>
                            <div class="rating">
        ...
        <div class="page-btn">
  {{ $res->links("vendor.pagination.default") }}
        </div>
    </div>
